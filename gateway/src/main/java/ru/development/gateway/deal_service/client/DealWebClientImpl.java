...
public class DealWebClientImpl implements DealClient {
    ...
    public void finalizeLoanParameters(FinishRegistrationRequestDto dto, String statementId) {
        webClient.post()
                .uri(dealMSProperties.getServerUrl().concat(dealMSProperties.getFinalizeLoanParametersUrl()), statementId)
                .bodyValue(dto)
                .retrieve()
    ...
    public void sendDocuments(String statementId) {
        webClient.post()
                .uri(dealMSProperties.getServerUrl().concat(dealMSProperties.getSendDocumentsUrl()), statementId)
                .retrieve()
                .onStatus(HttpStatusCode::isError,
                        this::processResponse)
                .bodyToMono(Void.class)
    ...
    public void updateStatementDocStatus(String statementId) {
        webClient.post()
                .uri(dealMSProperties.getServerUrl().concat(dealMSProperties.getUpdateStatementDocStatusUrl()), statementId)
                .retrieve()
                .onStatus(HttpStatusCode::isError,
                        this::processResponse)
                .bodyToMono(Void.class)
    ...
    public void signDocuments(String statementId) {
        webClient.post()
                .uri(dealMSProperties.getServerUrl().concat(dealMSProperties.getSignDocumentsUrl()), statementId)
                .retrieve()
                .onStatus(HttpStatusCode::isError,
                        this::processResponse)
                .bodyToMono(Void.class)
    ...
    public void processSesCode(String statementId, String code) {
        webClient.post()
                .uri(dealMSProperties.getServerUrl(), uriBuilder -> uriBuilder
    ...
    public Statement getStatementById(String statementId) {
        return webClient.get()
                .uri(dealMSProperties.getServerUrl().concat(dealMSProperties.getGetStatementByIdUrl()), statementId)
                .retrieve()
                .onStatus(HttpStatusCode::isError,
                        this::processResponse)
