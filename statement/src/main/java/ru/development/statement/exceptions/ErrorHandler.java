...
public class ErrorHandler {
    private static final DateTimeFormatter timePattern = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
    ...
    public ErrorObject handle(WebClientResponseException exception) {
        ...
        return new ErrorObject(HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase().toUpperCase(), exception.getMessage(), LocalDateTime.now().format(timePattern));
    }
